<template>
	<view style="height: 100vh;" :class="nightStatus ? 'nightTheme' : ''">
		...
		<view class="flex align-center justify-center" style="height:220rpx;">
			<image
				src="https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1605195825875&di=52d74546fd85360917d6cb7d08ee4f8d&imgtype=0&src=http%3A%2F%2Fi0.hdslb.com%2Fbfs%2Farchive%2F747ea8fa4b2b918f1d82e64cbda3d289cbae0615.jpg"
				lazy-load
				mode="widthFix"
				style="border-radius: 35rpx;box-shadow: 0 2rpx 6rpx 0; height: 220rpx;"
				alt="altText"
			/>
		</view>
